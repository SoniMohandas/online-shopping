...
import com.revature.runners.FlipCartDriver;
...
public class SearchProduct extends FlipCartDriver {
    ...
    public Object[][] excelData(){
        return getExcelData("src/test/java/com/revature/exceldata/productData.xlsx", "Sheet1");
    }
...
//    }
    ...
    public void user_select_the_product() throws InterruptedException {
        ...
        for(int i =0; i<list.size(); i++){
            if(list.get(i).getText().equals("APPLE iPhone 13 (Green, 128 GB)")) {
                list.get(i).click();
                break;
            }
        }
